...
files_to_add = [
  'Sources/DiagnosticsView/Views/PerformanceDashboardView.swift',
  'Sources/AppView/Screens/DeveloperStudio/DeveloperStudioScreen.swift',
  'Sources/Views/ModelManagementView.swift',
  'Sources/Views/RuntimeAdministrationView.swift'
]
